...
function markCompletedPages() {
    ...
    if (data) {
        for (let i = 0; i < data.length; i++) {
            ...
            setTimeout(addCheckIcon($(selector)), 500)
        }
    }
}
...
function initStcBtn() {
    ...
    //stc-button interaction:
    $(".stcbtn").click(function() {
        console.log("okna2:" + $(this).attr("data-overlayid"));
        var stcid = "#" + $(this).attr("data-overlayid");
        $(stcid).trigger("open.wb-overlay");
